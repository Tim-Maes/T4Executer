...
namespace TTExecuter
{
    ...
    internal sealed class EnableDisableTTExecuterCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnableDisableTTExecuterCommand"/> class.
        ...
        {
            // Switch to the main thread - the call to AddCommand in EnableDisableTTExecuterCommand's constructor requires
            // the UI thread.
