...
namespace TTExecuter.Commands
{
    ...
    internal sealed class ExcecuteAfterBuildCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcecuteAfterBuildCommand"/> class.
        ...
        {
            // Switch to the main thread - the call to AddCommand in ExcecuteAfterBuildCommand's constructor requires
            // the UI thread.
